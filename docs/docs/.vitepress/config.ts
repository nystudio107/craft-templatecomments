...
export default defineConfig({
  ...
  base: '/docs/template-comments/v4/',
  lang: 'en-US',
  head: [
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/nystudio107/craft-templatecomments/edit/develop-v4/docs/docs/:path',
    ...
    nav: [
      ...
      {
        text: 'v4', items: [
          {text: 'v5', link: 'https://nystudio107.com/docs/template-comments/'},
          {text: 'v4', link: '/'},
